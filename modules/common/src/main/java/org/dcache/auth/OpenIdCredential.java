...
public class OpenIdCredential implements BearerToken, Serializable
{
    private static final long serialVersionUID = 1L;
    private static final Logger LOG =
            LoggerFactory.getLogger(OpenIdCredential.class);
    ...
    private OpenIdCredential(OidCredentialBuilder builder) {
    ...
    public boolean equals(Object o)
    {
        if (this == o)
            return true;
        if (!(o instanceof OpenIdCredential))
            return false;

        OpenIdCredential that = (OpenIdCredential) o;
    ...
    public static class OidCredentialBuilder
    {
        ...
        public OpenIdCredential build()
        {
            return new OpenIdCredential(this);
        }
    }
}
